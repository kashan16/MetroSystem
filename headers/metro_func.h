...
public:
    ...
    static void addEdge(std::vector<std::vector<std::pair<int, int>>>& adj, std::map<std::string, int>& stationIndices,
    ...
    static int menu(std::vector<std::vector<std::pair<int, int>>>& adj, std::map<std::string, int>& stationIndices,
